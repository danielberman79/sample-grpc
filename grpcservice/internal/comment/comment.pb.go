...
// source: grpcservice/api/comment.proto
...
func init() {
	proto.RegisterFile("grpcservice/api/comment.proto", fileDescriptor_8824cdff2c16b081)
}
...
var _CommentService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpcservice/api/comment.proto",
}
